...
const largeIconProps = {
    ...iconProps,
    className: "w-12 h-12 text-purple-400 drop-shadow-[0_0_8px_#a855f7]"
}
...
export const AiFeaturesIcon = () => (
    <svg {...iconProps} viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 19.5V21M12 3v1.5m0 15V21m3.75-18v1.5M19.5 8.25H21M19.5 12H21m-3.75 3.75H21m-3.75 3.75H21M12 19.5V21M12 4.5a7.5 7.5 0 100 15 7.5 7.5 0 000-15z" />
...
export const TranscribeIcon = () => (
    <svg {...largeIconProps} viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12-9A6 6 0 006 3.75v1.5M12 12.75a3 3 0 01-3-3v-1.5a3 3 0 016 0v1.5a3 3 0 01-3 3z" />
    </svg>
);
